        ...
        <header className={styles.header}>
            <div className={styles.wrap}>
                <div className={styles.logo}>
                    ...
                    <FontAwesomeIcon icon={faBars} className={styles.bar} onClick={ToggleNavElement}/>
                </div>
                <div className={styles.nav} ref={navElementRef}>
                    <div className={styles.item}><Link href="/">Home</Link></div>
                    <div className={styles.item}><Link href="/projects">Projects</Link></div>
                    <div className={styles.item}><Link href="/aboutme">AboutMe</Link></div>
                </div>
